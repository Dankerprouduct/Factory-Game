...
namespace Factory_Game
{
    public class Camera
    {
        ...
        {
            gme = game;
            center = new Vector2((game.player.position.X - (game.player.CurrentBounds().Width / 2) - (game.WIDTH / 2)) * scale, (game.player.position.Y - (game.player.CurrentBounds().Height / 2) - (game.HEIGHT / 2)) * scale);
